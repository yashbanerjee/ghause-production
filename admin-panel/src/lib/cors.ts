...
export type CorsOptions = {
  /** Use when the client sends credentials (cookies / Authorization with credentials mode). */
  credentials?: boolean;
};

export function getCorsHeaders(origin: string | null, options?: CorsOptions) {
